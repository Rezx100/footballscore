...
export function HomeTabGlyph() {
  return (
    <Icon size={24} viewBox="0 0 24 24">
      <path
        d="M4 10.5L12 4L20 10.5V20C20 20.2652 19.8946 20.5196 19.7071 20.7071C19.5196 20.8946 19.2652 21 19 21H14V15H10V21H5C4.73478 21 4.48043 20.8946 4.29289 20.7071C4.10536 20.5196 4 20.2652 4 20V10.5Z"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
