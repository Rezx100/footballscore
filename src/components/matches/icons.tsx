...
export function CalendarIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M4 10h16M8 4v4M16 4v4" strokeLinecap="round" />
    </svg>
  );
}
...
export function TvIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <rect x="3.5" y="6.5" width="17" height="11.5" rx="1.8" />
...
export function NewsIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M5 6.5h11.5A2.5 2.5 0 0 1 19 9v9.5H7A2 2 0 0 1 5 16.5z" />
      <path d="M8 10h7M8 13.5h5" strokeLinecap="round" />
    </svg>
  );
}
...
export function TrophyIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M8 7H5.8A2.8 2.8 0 0 0 8 11.2M16 7h2.2A2.8 2.8 0 0 1 16 11.2" />
      <path d="M12 13v3M9 20h6M10.5 17h3" strokeLinecap="round" />
    </svg>
  );
}
...
export function StarIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="m12 4.5 2.3 4.7 5.2.8-3.8 3.6.9 5.2L12 16.6 7.4 18.8l.9-5.2-3.8-3.6 5.2-.8z" />
    </svg>
  );
}
